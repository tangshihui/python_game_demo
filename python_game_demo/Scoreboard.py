...
class Scoreboard():
    ...
    def prep_score(self):
        ...
        score_str="P:{:,}".format(rounded_score)
    ...
    def prep_high_score(self):
        ...
        score_str="H:"+"{:,}".format(rounded_score)
    ...
    def prep_level(self):
        ...
        self.level_image=self.font.render("L:"+str(self.stats.level),True,self.text_color,self.ai_settings.bg_color)
